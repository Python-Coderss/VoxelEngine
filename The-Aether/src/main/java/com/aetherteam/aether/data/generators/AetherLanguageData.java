...
public class AetherLanguageData extends AetherLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.addMoaSkinsText("skin.pink_moa", "Pink Moa");
        this.addMoaSkinsText("skin.bronze_moa", "Bronze Moa");
        this.addMoaSkinsText("skin.silver_moa", "Silver Moa");
        this.addMoaSkinsText("skin.gold_moa", "Gold Moa");
        ...
        this.addLore(AetherItems.AECHOR_PETAL, "The petal of an Aechor Plant with a sweet aroma to it. These are a Moa's favorite food and can be used to feed baby Moas.");
        ...
        this.addLore(AetherItems.BLACK_MOA_EGG, "An egg laid by a Black Moa. Hatching this provides a Black Moa with 8 mid-air jumps, the best and rarest one!");
        ...
        this.addLore(AetherBlocks.CRYSTAL_LEAVES, "Leaves that come from Crystal Trees, which generate on floating islands. Sometimes they bear fruit that can cure Inebriation.");
        ...
        this.addLore(AetherItems.FLAMING_SWORD, "An ancient sword which burns its foes to a crisp. It almost hurts to touch! Using this on animals can make them drop cooked meat!");
        ...
        this.addLore(AetherBlocks.GOLDEN_OAK_LEAVES, "These golden leaves generate with Golden Oak Trees. They spawn golden particles in a radius of 5 blocks. They yield Golden Oak Saplings and Skyroot Sticks when they decay.");
        ...
        this.addLore(AetherBlocks.HELLFIRE_STONE, "A warm, red stone that makes up most of the Gold Dungeon's interior. It cannot be destroyed until the Sun Spirit is defeated.");
        ...
        this.addLore(AetherItems.HOLY_SWORD, "An ancient sword which does heavy damage to undead foes. A perfect weapon for traversing the Overworld.");
        this.addLore(AetherBlocks.HOLYSTONE, "The Aether's native rock. It can be used in various ways, such as tool creation, construction, and crafting Holystone Bricks.");
        ...
        this.addLore(AetherBlocks.MOSSY_HOLYSTONE, "A more aged Holystone, it is found near dungeons and has pale colored vines growing on it. It can be very decorative!");
        ...
        this.addLore(AetherItems.NATURE_STAFF, "A staff that can allow for commanding tamed Moas. It allows them to sit on the ground.");
        ...
        this.addLore(AetherItems.PHOENIX_BOOTS, "Found in Gold Dungeons, when fully worn, this armor set grants fire resistance; you can swim in lava as well. Be careful when standing in water, as it will turn into obsidian armor.");
        ...
        this.addLore(AetherItems.PHOENIX_CHESTPLATE, "Found in Gold Dungeons, when fully worn, this armor set grants fire resistance; you can swim in lava as well. Be careful when standing in water, as it will turn into obsidian armor.");
        ...
        this.addLore(AetherItems.PHOENIX_HELMET, "Found in Gold Dungeons, when fully worn, this armor set grants fire resistance; you can swim in lava as well. Be careful when standing in water, as it will turn into obsidian armor.");
        this.addLore(AetherItems.PHOENIX_LEGGINGS, "Found in Gold Dungeons, when fully worn, this armor set grants fire resistance; you can swim in lava as well. Be careful when standing in water, as it will turn into obsidian armor.");
        ...
        this.addLore(AetherBlocks.PRESENT, "Break this to get a wonderful holiday gift! Be careful, as there's a chance you could get ssssssurprised!");
        ...
        this.addLore(AetherBlocks.SKYROOT_LEAVES, "These leaves generate with Skyroot Trees. They can drop Skyroot Saplings and Skyroot Sticks when they decay.");
        ...
        this.addServerConfig("gameplay", "crystal_leaves_consistency", "Makes Crystal Fruit Leaves behave consistently with Sweet Berry Bushes");
        ...
        this.addServerConfig("modpack", "normal_length_aether_time", "Sets the Aether's time cycle to be the same length as the Overworld's");
        this.addServerConfig("modpack", "sync_aether_time", "Syncs the Aether's time cycle to the Overworld's");
