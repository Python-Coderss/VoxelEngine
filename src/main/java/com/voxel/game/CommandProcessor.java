...
public class CommandProcessor {
    ...
    private void handleHelp() {
        ...
        sb.append("\n  /spawn <mob> - Spawn a mob where you're looking (zombie, skeleton, spider, enderman, endermite, silverfish, creeper, villager, iron_golem, snow_golem, snow_golem_sheared, blaze, pigman, pig, cow, chicken, sheep, sheep_sheared)");
